...
import { authToken } from "../middleware/auth.middleware.js";
 import {lockUniversity,unlockUniversity, getLockedUniversityDetails, updateStage} from "../controllers/lockUniversity.controller.js"
const router = Router();
...
router.patch('/updateStage',authToken,updateStage);
